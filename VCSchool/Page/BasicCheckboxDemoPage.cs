...
{
    class BasicCheckboxDemoPage: BasePage
    {
        private const string _singleCheckBoxMessageText = "Success - Check box is checked";

        private const string _pageAddress = "https://www.seleniumeasy.com/test/basic-checkbox-demo.html";//isimta is SetUp
        ...
        public BasicCheckboxDemoPage(IWebDriver webdriver) : base(webdriver)
        {
            ...
            //Driver.Navigate().GoToUrl(_pageAddress);
        }
